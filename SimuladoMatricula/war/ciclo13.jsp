  ...
  <div id="content">
    ...
    <form action=/matricular method="POST" class="ciclo-form">
	    <select class="ciclo-select" name="ciclo">
		  ...
		  <option value="13" selected>Ingenier&iacute;a de Software</option>
		  <option value="14">Electivos libres</option>
		</select>
    ...
    <tr style="color: #5F91DC">
      <td><%=reporte.get(8).getIdCurso() %> - <%=reporte.get(8).getNombre() %></td><td><%=reporte.get(8).getAlumnos() %></td>
    </tr>
    <tr style="color: #ED9C13">
      <td><%=reporte.get(9).getIdCurso() %> - <%=reporte.get(9).getNombre() %></td><td><%=reporte.get(9).getAlumnos() %></td>
    </tr>

<!--     <tr style="color: #ED5713"> -->
<%--       <td><%=reporte.get(10).getIdCurso() %> - <%=reporte.get(10).getNombre() %></td><td><%=reporte.get(3).getAlumnos() %></td> --%>
<!--     </tr> -->

<!--     <tr style="color: #057249"> -->
<%--       <td><%=reporte.get(11).getIdCurso() %> - <%=reporte.get(11).getNombre() %></td><td><%=reporte.get(4).getAlumnos() %></td> --%>
<!--     </tr> -->
