...
<%@ page import="com.taller.proyectos.bean.CursoBean" %>
...
<body>
<%
List<CursoBean> reporte = ( ArrayList<CursoBean>)request.getAttribute("reporte");
%>
...
<%-- 		<div class="right"><br><%=noticias %></div> --%>
    
  </div>
            
  <div id="content">
    <div class="left col1">
    <form action=/matricular method="POST" class="ciclo-form">
	    <select class="ciclo-select" name="ciclo">
		  ...
		  <option value="11">Sistemas de Informaci&oacute;n</option>
		  <option value="12">Tecnolog&iacute;as de Informaci&oacute;n</option>
		  <option value="13">Ingenier&iacute;a de Software</option>
		  <option value="14" selected>Electivos libres</option>
		</select>
		<input type="submit" value="Ir" class="ciclo-button">
    </form>
      <table id="chartData">

    <!--<tr>
      <th>TEXTO</th><th>Nro</th>
     </tr>-->

	

    <tr style="color: #0DA068">
      <td><%=reporte.get(0).getIdCurso() %> - <%=reporte.get(0).getNombre() %></td><td><%=reporte.get(0).getAlumnos() %></td>
    </tr>

    <tr style="color: #194E9C">
      <td><%=reporte.get(1).getIdCurso() %> - <%=reporte.get(1).getNombre() %></td><td><%=reporte.get(1).getAlumnos() %></td>
    </tr>

    <tr style="color: #ED9C13">
      <td><%=reporte.get(2).getIdCurso() %> - <%=reporte.get(2).getNombre() %></td><td><%=reporte.get(2).getAlumnos() %></td>
    </tr>

    <tr style="color: #ED5713">
      <td><%=reporte.get(3).getIdCurso() %> - <%=reporte.get(3).getNombre() %></td><td><%=reporte.get(3).getAlumnos() %></td>
    </tr>

    <tr style="color: #057249">
      <td><%=reporte.get(4).getIdCurso() %> - <%=reporte.get(4).getNombre() %></td><td><%=reporte.get(4).getAlumnos() %></td>
    </tr>

    <tr style="color: #5F91DC">
      <td><%=reporte.get(5).getIdCurso() %> - <%=reporte.get(5).getNombre() %></td><td><%=reporte.get(5).getAlumnos() %></td>
    </tr>
    
    <tr style="color: #ED5713">
      <td><%=reporte.get(6).getIdCurso() %> - <%=reporte.get(6).getNombre() %></td><td><%=reporte.get(6).getAlumnos() %></td>
    </tr>
    
    <tr style="color: #194E9C">
      <td><%=reporte.get(7).getIdCurso() %> - <%=reporte.get(7).getNombre() %></td><td><%=reporte.get(7).getAlumnos() %></td>
    </tr>
    <tr style="color: #ED9C13">
      <td><%=reporte.get(8).getIdCurso() %> - <%=reporte.get(9).getNombre() %></td><td><%=reporte.get(8).getAlumnos() %></td>
    </tr>

    <tr style="color: #ED5713">
      <td><%=reporte.get(9).getIdCurso() %> - <%=reporte.get(10).getNombre() %></td><td><%=reporte.get(9).getAlumnos() %></td>
    </tr>

    <tr style="color: #057249">
      <td><%=reporte.get(10).getIdCurso() %> - <%=reporte.get(11).getNombre() %></td><td><%=reporte.get(10).getAlumnos() %></td>
    </tr>
    
    <tr style="color: #194E9C">
      <td><%=reporte.get(11).getIdCurso() %> - <%=reporte.get(1).getNombre() %></td><td><%=reporte.get(11).getAlumnos() %></td>
    </tr>

    <tr style="color: #ED9C13">
      <td><%=reporte.get(12).getIdCurso() %> - <%=reporte.get(2).getNombre() %></td><td><%=reporte.get(12).getAlumnos() %></td>
    </tr>

    <tr style="color: #ED5713">
      <td><%=reporte.get(13).getIdCurso() %> - <%=reporte.get(3).getNombre() %></td><td><%=reporte.get(13).getAlumnos() %></td>
    </tr>

    <tr style="color: #057249">
      <td><%=reporte.get(14).getIdCurso() %> - <%=reporte.get(4).getNombre() %></td><td><%=reporte.get(14).getAlumnos() %></td>
    </tr>
  ...
  <br>
  <br>
  <form action=/matricular method="GET" class="ciclo-form">
  	<input style="margin: 10px; height: 40px; width: 220px;" type="number" name="alumno" placeholder="C&oacute;digo Alumno">
  	<input type="hidden" name="key" value="1">
  	<input type="submit" style="display: none;" id="alu">
  	<label style="background: #7B1229; color: #fff; padding: 10px; border-radius: 7px;" for="alu">Buscar Cursos Alumno</label>
  </form>
  
  <p style="margin-left: 12%;">*Ejem. 2012234321</p>

<form action=/matricular method="GET" class="ciclo-form">
  	<input style="margin: 10px; height: 40px; width: 220px;" type="number" name="curso" placeholder="C&oacute;digo Curso">
  	<input type="hidden" name="key" value="2">
  	<input type="submit" style="display: none;" id="cur">
  	<label style="background: #7B1229; color: #fff; padding: 10px; border-radius: 7px;"for="cur">Buscar Cursos Alumno</label>
  </form>
<p style="margin-left: 12%; margin-bottom: 7%;">*[codigo curso] - [Nombre curso]</p>
