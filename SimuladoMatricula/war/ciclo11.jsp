  ...
  <div id="content">
    ...
    <form action=/matricular method="POST" class="ciclo-form">
	    <select class="ciclo-select" name="ciclo">
		  ...
		  <option value="11" selected>Sistemas de Informaci&oacute;n</option>
    ...
    <tr style="color: #057249">
      <td><%=reporte.get(10).getIdCurso() %> - <%=reporte.get(10).getNombre() %></td><td><%=reporte.get(10).getAlumnos() %></td>
    </tr>
